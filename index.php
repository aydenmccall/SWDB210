    ...
    <main>
        ...
        <div class="carousel flexBox">
            ...
            <div id="carouselLinks" class="flexChild">
                <ul class="noDisplay carouselImage"><a href="store.html" class="nav-color">
                        <p>Coffee Beans</p><img src="img/coffee-tin-640.jpg" alt="Image of Coffee Tin">
                    </a></ul>
                <ul class="noDisplay carouselImage"><a href="store.html" class="nav-color">
                        <p>Appliances</p><img src="img/coffee-scoop-640.jpg" alt="Image of Espresso Press">
                    </a></ul>
